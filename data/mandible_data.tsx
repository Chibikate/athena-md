...
export const MandibleCourses = [
  {
    ...
    to: "/main_homepage/mandible/3D slicer interface",
  },
  {
...
export interface MandibleDataProps {
  hero: NewProps;
  objectives: ObjectiveProps;
  to: string;
} 
const slicerInterface: MandibleDataProps = {
  hero: {
    hero: {
      title: "3D Slicer Interface (A-1)",
      difficulty: "Beginner",
...
const dicomDatasets: MandibleDataProps = {
  hero: {
    hero: {
      title: "3D slicer - Adding DICOM datasets (A-2)",
      difficulty: "Beginner",
...
const dicomDisplay: MandibleDataProps = {
  hero: {
    hero: {
      title: "3D slicer - Navigating DICOM display (A-3)",
      difficulty: "Beginner",
...
const basicSegmentation: MandibleDataProps = {
  hero: {
    hero: {
      title: "3D slicer -  Basic-Segmentation (A-4)",
...
const advancedSegmentation1: MandibleDataProps = {
  hero: {
    hero: {
      title: "3D slicer - Advanced Segmentation-1  (A-5)",
      difficulty: "Difficult",
...
const MeshMixer: MandibleDataProps = {
  hero: {
    hero: {
      title: "MeshMixer - Virtual-Surgery (B-1)",
      difficulty: "Difficult",
