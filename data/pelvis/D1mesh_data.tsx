  ...
  },
  {
    ...
    description: (
      <div className="flex flex-col space-y-4">
        <p>
          Outstanding work! You have successfully completed the MeshMixer Virtual Surgery module for pelvis fracture reduction. You've learned how to:
        </p>
        <p>
          These skills are invaluable for surgical planning, allowing you to visualize and plan fracture reduction strategies before entering the operating room.
        </p>
        ...
        <p className="text-sm text-gray-600 text-center mt-2">
          Complete the quiz to earn your certificate in Virtual Surgical Planning
        </p>
      </div>
    ),
    image: null,
