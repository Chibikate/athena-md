...
const Meshmixer2Certificate = React.forwardRef(({ fullName, date }, ref) => {
  return (
    ...
    <div className="container mx-auto flex flex-row items-center justify-center" ref={ref}>
      <div className={`w-[845px] mx-auto  bg-[#ffffff] p-5 border-x-2 m-8 border-y-2 rounded-md shadow-md ${interGaramond.className} border-[#10172c] flex flex-col`}>
        ...
        <p className="absolute pt-80 mb-24 ml-28 items-center"><span className="font-bold text-xl"J>MESHMIXER VIRTUAL SURGERY </span><br/> in Mobile-Responsive Web-based Tutorial System <br />
...
Meshmixer2Certificate.displayName = 'PMeshmixer2Certificate'; // Set the display name

export default Meshmixer2Certificate;
