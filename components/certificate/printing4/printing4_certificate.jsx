...
const Printing4Certificate = React.forwardRef(({ fullName, date }, ref) => {
  return (
    <div
    ...
    >
      ...
      >
        ...
        <div className="text-left pl-5 sm:pl-20 pt-10 absolute mt-0 p-20 pb-0 sm:mt-10 sm:text-center sm:pb-20">
          ...
          <p className="font-bold text-lg sm:text-md md:text-lg my-0 sm:my-2 text-center "> Ultimaker Cura Printing Tools </p>
...
Printing4Certificate.propTypes = {
  fullName: PropTypes.string.isRequired,
  date: PropTypes.string.isRequired
};

Printing4Certificate.displayName = 'Printing4Certificate'; // Set the display name

export default Printing4Certificate;
