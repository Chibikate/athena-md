...
interface CourseLayoutProps {
  ...
  coursePath: string;
  renderCard: (cardProps: CardProps) => React.ReactElement;
}
...
const CourseLayout = ({
  ...
  const renderDesktopPreviousButton = () => {
    return (
      <button
        onClick={index > 0 ? goToPreviousQuestion : () => window.location.href = coursePath}
  ...
  // Function to render the mobile previous button
