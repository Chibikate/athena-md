...
function CertificatePage() {
  ...
  const downloadCertificate = async () => {
    ...
    try {
      ...
      pdf.save(`${name.replace(/\s+/g, "_")}_Pelvis_Basic_Certificate.pdf`);
    } catch (error) {
        ...
        <div className="w-full max-w-5xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-gray-600">
              Congratulations on completing the Pelvis Basic module!
            </p>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-6 mb-8">
            ...
            <Link
              href="/pelvis/3D%20slicer%20Pelvis%20-%20Advanced%20Segmentation-1"
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    ...
                    showcase your basic skills in pelvis medical imaging.
                  </p>
                </div>
              </div>
            </div>
