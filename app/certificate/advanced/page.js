...
function CertificatePage() {
  ...
  const downloadCertificate = async () => {
    ...
    try {
      ...
      pdf.save(`${name.replace(/\s+/g, '_')}_Advanced_Certificate.pdf`);
    } catch (error) {
      ...
      <main className="flex-grow flex flex-col items-center px-4 py-8 md:py-12">
        <div className="w-full max-w-5xl">
          ...
          <div className="text-center mb-8">
            <h1 className="text-2xl md:text-3xl font-bold text-[#043873]">Your Advanced Certificate of Completion</h1>
            <p className="mt-2 text-gray-600">Congratulations on completing the Advanced 3D Imaging module!</p>
          </div>
            ...
            <div className="bg-white rounded-lg shadow-md border border-gray-100 p-5">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Add this advanced certificate to your LinkedIn profile or resume to showcase your expertise in medical 3D imaging.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md border border-gray-100 p-5">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Proceed to the MeshMixer Virtual Surgery module to further enhance your medical modeling skills.</p>
                </div>
              </div>
            </div>
          </div>
