...
import Printing2Certificate from "../../../components/certificate/printing2/printing2_certificate";
...
function CertificatePage() {
  ...
  const downloadCertificate = async () => {
    ...
    try {
      ...
      pdf.save(`${name.replace(/\s+/g, '_')}_3D_Printing_Certificate.pdf`);
    } catch (error) {
      ...
      <main className="flex-grow flex flex-col items-center px-4 py-8 md:py-12">
        <div className="w-full max-w-5xl">
          ...
          <div className="text-center mb-8">
            <h1 className="text-2xl md:text-3xl font-bold text-[#043873]">Your Certificate of Completion</h1>
            <p className="mt-2 text-gray-600">Congratulations on completing the 3D Printing Advanced module!</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-4 md:p-6 mb-8 border border-[#FDCC6D]/20">
            ...
            <div className="mb-6 overflow-hidden rounded-lg">
              <Printing2Certificate fullName={name} date={date} ref={certRef} />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white rounded-lg shadow-md border border-gray-100 p-5">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Add this certificate to your LinkedIn profile or resume to showcase your advanced skills in medical 3D printing.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md border border-gray-100 p-5">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-[#043873] mb-2">Continue Learning</h3>
                  <p className="text-gray-600">Explore more courses to deepen your knowledge in medical 3D printing techniques.</p>
                </div>
              </div>
            </div>
          </div>
