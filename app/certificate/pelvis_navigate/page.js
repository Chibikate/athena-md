...
import PelvisNavigateCertificate from "../../../components/certificate/pelvis_navigate/pelvisnavigate_certificate";
...
function CertificatePage() {
  ...
  const downloadCertificate = async () => {
    ...
    try {
      ...
      pdf.save(
        `${name.replace(/\s+/g, "_")}_Pelvis_Navigate_Certificate.pdf`
      );
    } catch (error) {
        ...
        <div className="w-full max-w-5xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-gray-600">
              Congratulations on completing the Pelvis Navigation module!
            </p>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-6 mb-8">
            ...
            <Link
              href="/pelvis/3D%20slicer%20Pelvis%20-%20Basic-Segmentation"
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    ...
                    showcase your skills in navigating pelvis DICOM data.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md border border-gray-100 p-5">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Explore more courses to deepen your knowledge in pelvis
