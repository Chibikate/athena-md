...
function CertificatePage() {
  ...
  const downloadCertificate = async () => {
    ...
    try {
      ...
      pdf.save(`${name.replace(/\s+/g, '_')}_Basic_Segmentation_Certificate.pdf`);
    } catch (error) {
      ...
      <main className="flex-grow flex flex-col items-center px-4 py-8 md:py-12">
        <div className="w-full max-w-5xl">
          ...
          <div className="text-center mb-8">
            <h1 className="text-2xl md:text-3xl font-bold text-[#043873]">Your Basic Segmentation Certificate of Completion</h1>
            <p className="mt-2 text-gray-600">Congratulations on completing the Basic Segmentation module!</p>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-6 mb-8">
            ...
            <Link 
              href="/course/3D%20slicer%20-%20Advanced%20Segmentation-1"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white rounded-lg shadow-md border border-gray-100 p-5">
              <div className="flex items-start">
                <div className="rounded-full bg-blue-50 p-3 mr-4">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#043873]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-[#043873] mb-2">Share Your Achievement</h3>
                  <p className="text-gray-600">Add this certificate to your LinkedIn profile or resume to showcase your skills in medical 3D imaging segmentation.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md border border-gray-100 p-5">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-[#043873] mb-2">Continue Your Journey</h3>
                  <p className="text-gray-600">Proceed to the Advanced Segmentation module to further enhance your medical imaging skills.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="text-center mb-8">
            <Link 
              href="/"
              className="inline-flex items-center text-[#043873] hover:underline font-medium"
            >
