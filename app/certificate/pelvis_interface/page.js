...
function CertificatePage() {
  ...
  const downloadCertificate = async () => {
    ...
    try {
      ...
      pdf.save(`${name.replace(/\s+/g, '_')}_Pelvis_Interface_Certificate.pdf`);
    } catch (error) {
      ...
      <main className="flex-grow flex flex-col items-center px-4 py-8 md:py-12">
        <div className="w-full max-w-5xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-gray-600">Congratulations on completing the Pelvis Interface module!</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-4 md:p-6 mb-8 border border-[#FDCC6D]/20">
            ...
            <div className="mb-6 overflow-hidden rounded-lg">
              <PelvisInterfaceCertificate fullName={name} date={date} ref={certRef} />
            </div>
          </div>
            ...
            <div className="bg-white rounded-lg shadow-md border border-gray-100 p-5">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Add this certificate to your LinkedIn profile or resume to showcase your skills in navigating the 3D Slicer Pelvis interface.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md border border-gray-100 p-5">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Explore more courses to deepen your knowledge in pelvis imaging and 3D visualization.</p>
                </div>
              </div>
            </div>
          </div>
