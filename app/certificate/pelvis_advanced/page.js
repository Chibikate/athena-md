...
import PelvisAdvancedCertificate from "../../../components/certificate/pelvis_advanced/pelvisadvanced_certificate";
...
function CertificatePage() {
  ...
  const downloadCertificate = async () => {
    ...
    try {
      ...
      pdf.save(
        `${name.replace(/\s+/g, "_")}_Pelvis_Advanced_Certificate.pdf`
      );
    } catch (error) {
        ...
        <div className="w-full max-w-5xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-gray-600">
              Congratulations on completing the Pelvis Advanced module!
            </p>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-6 mb-8">
            ...
            <Link
              href="/pelvis/MeshMixer2%20-%20Pelvis%20Virtual-Surgery"
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    ...
                    showcase your advanced pelvis imaging skills.
                  </p>
                </div>
              </div>
            </div>
