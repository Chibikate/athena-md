...
import Printing4Certificate from "../../../components/certificate/printing4/printing4_certificate";
...
function CertificatePage() {
  ...
  const downloadCertificate = async () => {
    ...
    try {
      ...
      pdf.save(
        `${name.replace(/\s+/g, "_")}_3D_Printing_Master_Certificate.pdf`
      );
    } catch (error) {
        ...
        <div className="w-full max-w-5xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-gray-600">
              Congratulations on completing the 3D Printing Master module!
            </p>
          </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    ...
                    showcase your mastery in medical 3D printing techniques.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md border border-gray-100 p-5">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Explore more courses to deepen your knowledge in advanced
                    medical 3D printing and manufacturing.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="text-center">
            <h2 className="text-xl font-bold text-[#043873] mb-4">
