...
function CertificatePage() {
  ...
  const downloadCertificate = async () => {
    ...
    try {
      ...
      pdf.save(`${name.replace(/\s+/g, '_')}_Interface_Certificate.pdf`);
    } catch (error) {
      ...
      <main className="flex-grow flex flex-col items-center px-4 py-8 md:py-12">
        <div className="w-full max-w-5xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-gray-600">Congratulations on completing the 3D Slicer Interface module!</p>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-6 mb-8">
            ...
            <Link 
              href="/course/3D%20slicer%20-%20Adding%20DICOM%20datasets"
            ...
            <div className="bg-white rounded-lg shadow-md border border-gray-100 p-5">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Add this certificate to your LinkedIn profile or resume to showcase your new skills in 3D Slicer interface navigation.</p>
                </div>
              </div>
            </div>
