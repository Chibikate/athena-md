...
export default function QuizApp() {
  ...
  return (
    <div 
    className="min-h-screen flex flex-col items-center px-4 py-6 md:px-6"
    style={{
    ...
    >
      ...
      <div className="w-full max-w-screen-xl mx-auto mt-20 md:mt-24">
        {/* Quiz title */}
        <h1 className="text-xl md:text-2xl font-bold text-center my-4 md:mb-6 text-blue-900">3D Pelvis Interface Quiz</h1>
        
        {/* Quiz container */}
        <div className="bg-white rounded-lg shadow-md p-4 md:p-6 lg:p-8 w-full max-w-4xl mx-auto mt-6 border border-blue-100">
          {!showResults ? (
            <div>
                ...
                <div className="flex justify-between mt-6 md:mt-8">
                  {currentQuestion > 0 ? (
                    <button
                      ...
                      className="px-4 md:px-6 py-2 border border-gray-300 rounded text-sm md:text-base text-gray-700 hover:bg-gray-50 transition-colors"
                    >
                      Previous
                    </button>
                  ) : <div></div>}
              ...
              {score === quizQuestions.length ? (
                <div>
                  ...
                  <Link href="/fillup/pelvis_interface">
                    <button className="bg-blue-900 text-white px-5 md:px-6 py-2 md:py-3 rounded text-sm md:text-base hover:bg-blue-800 transition-colors">
                      Get Your Certificate
                    </button>
                  </Link>
                  <div>
                  <Link href="/pelvis/3D%20slicer%20Pelvis%20-%20AddDICOM">
                    <button className="bg-[#043873] text-white px-4 py-2 cursor-pointer rounded-md hover:bg-indigo-600 mt-4 inline-block transition-colors">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex flex-col sm:flex-row justify-center items-center space-y-3 sm:space-y-0 sm:space-x-4">
                    <Link href="/pelvis/3D%20slicer%20Pelvis%20-%20Interface/data?content=3D%20slicer%20Pelvis%20C1" className="w-full sm:w-auto">
                      <button className="w-full px-4 md:px-6 py-2 border border-blue-900 text-blue-900 rounded text-sm md:text-base hover:bg-blue-50 transition-colors">
                        Retake the Lesson
                      </button>
                    </Link>
                    <button
                      onClick={retakeQuiz}
                      className="w-full sm:w-auto bg-blue-900 text-white px-4 md:px-6 py-2 rounded text-sm md:text-base hover:bg-blue-800 transition-colors"
                    >
                      Retake Quiz
                    </button>
                  </div>
