          ...
          {!showResults ? (
            <div>
              <div className="mb-6 md:mb-8">
                ...
                {quizQuestions[currentQuestion].image && quizQuestions[currentQuestion].image !== "" && (
              ...
              {score === quizQuestions.length ? (
                ...
                <div className="bg-[#FFF5F5] border border-red-200 rounded-xl p-6 md:p-8 max-w-2xl mx-auto">
                  ...
                  <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
                    <Link 
                      href="/pelvis/3D%20slicer%20Pelvis%20-%20Interface/data?content=3D%20slicer%20Pelvis%20C1" 
