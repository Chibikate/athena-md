...
const quizQuestions = [
  ...
  {
    question:
    "Which option under the threshold function automatically activates the paint function, allowing the user to paint any area using the previously selected threshold intensity?", 
    ...
    <div className="min-h-screen bg-[#FEFCFA] flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center px-4 py-6 md:px-6">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-center text-[#043873] mt-6 mb-8">
          Pelvis Advanced Segmentation Quiz
        </h1>
